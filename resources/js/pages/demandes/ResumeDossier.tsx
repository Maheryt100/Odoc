// pages/demandes/ResumeDossier.tsx - ✅ CORRECTION TYPES
...
import { FileText, ArrowLeft, FileOutput, Info, Sparkles, Menu } from 'lucide-react';
import {
    AlertDialog,
    AlertDialogAction,
    AlertDialogCancel,
...
import type { DocumentDemande, DemandeWithDetails } from './types'; // ✅ Import ajouté

interface ResumeDossierProps {
    dossier: Dossier;
    documents: {
        // ✅ FIX: Typage correct des données
...
export default function ResumeDossier({ dossier, documents }: ResumeDossierProps) {
    ...
    // ✅ FIX: Handlers typés correctement
    const handleArchiveClick = (demandeWithDetails: DemandeWithDetails) => {
        // Extraire les données DocumentDemande depuis DemandeWithDetails
